...
continua em andamento para os demais casos. As preferências de alertas já
consomem localmente o contrato final, mergeado no interBackend PR #21, por
usuário e dispositivo; o deploy DEV e a validação ponta a ponta estão
pendentes. FCM
